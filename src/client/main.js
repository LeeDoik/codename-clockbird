...
import { SewerScene } from './scenes/SewerScene.js';
...
const game = new Phaser.Game({
  ...
  //   → Stage(거리) → Mansion(저택 잠입) → Sewer(지하수로, 아직 맵만)
  scene: [BootScene, IntroScene, TutorialScene, StageScene, MansionScene, SewerScene],
});
