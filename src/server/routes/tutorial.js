 ...
 * 기획 설정서(2026-08-04 판) '캐릭터 대사' 시트의 브란트 — 암호 3번 실패 대사.
 * 마지막 한 줄만 게임 쪽에서 덧붙였다 (들은 단어를 버리라는 지시가 설정서에는 없다).
 */
const OFFICER_REPLACE_LINE =
  '암호를 이렇게 자꾸 틀리면 동료의 신뢰를 잃지.\n' +
  '실전에서 신뢰를 잃는다는 것은 아주 위험하니, 신중할 수 있도록.\n\n' +
  '자, 이전 암호는 폐기 처리했다. 새로운 암호로 다시 시도한다.\n' +
  '방금까지 들은 단어는 전부 잊고, 동료들에게 다시 물어보고 오너라.';
